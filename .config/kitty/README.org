#+TITLE: Kitty
* Fonts
#+begin_src shell :tangle kitty.conf
...
#: background color.
#+end_src
* Color scheme (not used since I'm loading theme from separate file)
#+begin_src shell :tangle kitty.conf
#: Color scheme {{{
...
#+end_src
* Tab management (not used - default values)
#+begin_src shell :tangle kitty.conf
#: Tab management {{{
...
#+end_src
* Layout management (not used - default values)
#+begin_src shell :tangle kitty.conf
